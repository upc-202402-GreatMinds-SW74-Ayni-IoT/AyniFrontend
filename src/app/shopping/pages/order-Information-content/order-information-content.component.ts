...
import { CancelPurchaseDialogContentComponent } from '../../components/cancel-purchase-dialog-content/cancel-purchase-dialog-content.component';
  ...
  loadData() {
    this.route.params.subscribe((params) => {
      ...
      this.orderService.getById(purchaseId).subscribe((orderResponse: any) => {
        ...
        this.salesService
          .getById(this.order.saleId)
          .subscribe((saleResponse: any) => {
